...
public class FileBucketDemo {
	...
	// 运行前先设置好以下三个参数
	private static final String BUCKET_NAME = "gitchinatest";
	private static final String USER_NAME = "gchivalrous";
	private static final String USER_PWD = "ailonger";
